...
export default function InvoicesScreen() {
  ...
  const printInvoices = () => {
    ...
    win.document.write(`<!DOCTYPE html><html><head><title>All Invoices</title>
      ...
      <body>
        <h2><img src="https://res.cloudinary.com/dx1us5oiy/image/upload/Screenshot_2026-06-23_103649_hgb6dl.png" style="width:40px;height:40px;object-fit:contain;vertical-align:middle;margin-right:8px;background:#000;border-radius:4px;padding:2px;"/> RS APPARELS</h2> — All Invoices</h2>
